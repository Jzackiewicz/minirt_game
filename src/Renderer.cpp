                                                       ...
                                                       std::vector<Material> &mats)
{
        ...
        score_value = std::min(score_value, 999999.9);
        char score_buf[64];
        ...
        const int score_x = 5;
        const int score_y = 5;
        CustomCharacter::draw_text(ren, score_buf, score_x, score_y, score_color,
                                                    score_scale);
        int overlay_base_y = score_y + 7 * score_scale + 4;
